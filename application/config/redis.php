...
$config['redis_default']['host'] = '103.195.30.161';		// IP address or host
$config['redis_default']['port'] = '6379';			// Default Redis port is 6379
$config['redis_default']['password'] = 'kiselreD1S';			// Can be left empty when the server does not require AUTH
