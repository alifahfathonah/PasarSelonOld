                            ...
                            <div>
                                <p align="center">
                                    Lakukan pembayaran sebelum tanggal
                                        <b><?php echo $this->tanggal->formatDateTime($this->timezone->convertUtcAdd2Day($result->escrow->createdAt));?> </b>
                                </p>
<!--                                <pre>--><?php //print_r($result); ?><!--</pre>-->
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <p align="center" style="margin-top: 20px;">Kode Unik <b><?php echo $result->uniqueAmount; ?></b></p>
                                </div>
                                ...
                                <div style="text-align: center;">
                                    <a class="btn btn-login" href="<?php echo base_url('PPOB/unggah_bukti?orderId='.$orderId.'&escrow='.$result->escrow->id.'&vcr='.$voucher.''); ?>">Unggah Bukti</a>
                                </div>
                            </div>
                        </div>
                    </div>
